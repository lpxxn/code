...
protected:
    ...
    */
    virtual void drawTick( QPainter *painter, double value, double len ) = 0;
    ...
    */
    virtual void drawBackbone( QPainter *painter ) = 0;
    ...
    */
    virtual void drawLabel( QPainter *painter, double value ) = 0;
