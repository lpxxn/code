...
protected:
    ...
    virtual void drawTick( QPainter *, double val, double len ) ;
    virtual void drawBackbone( QPainter * ) ;
    virtual void drawLabel( QPainter *, double val ) ;

    void processLabel(QwtText& text, double value);
    QString processValue(double value) const;
