...
public:
    ...
    // Error Bar
    void setErrorBarPlusVisible(bool visible);
    bool isErrorBarPlusVisible() const;

    void setErrorBarMinusVisible(bool visible);
    bool isErrorBarMinusVisible() const;

    void setErrorBarLineColor(const QColor& clr);
    QColor errorBarLineColor() const;

    void setErrorBarLineWidth(int width);
    int errorBarLineWidth() const;

    void setErrorBarHandleWidth(int width);
    int errorBarHandleWidth() const;

    void setErrorBarLineOpacity(float opacity);
    float errorBarLineOpacity() const;
