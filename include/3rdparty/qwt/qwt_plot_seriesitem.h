...
public:
    ...
    */
    ...
    void setXErrorValues(const QVector<double>& vals);
    QVector<double> xErrorValues() const;

    void setYErrorValues(const QVector<double>& vals);
    QVector<double> yErrorValues() const;
