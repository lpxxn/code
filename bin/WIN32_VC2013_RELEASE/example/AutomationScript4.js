...
var loop = new rom.Loop('loop1',model);

var as = new rom.AutomationScript('aeroarg', loop);
//as.workDirectory = rom.SimFunction.BaseDirectory;
...
var lp = new rom.ReferenceParameter('loopParameter', 'model.loop1.aeroarg.file1.输入参数.Dfuse', true, false, loop);
loop.loopParameter = lp;
loop.setFrom(5);
loop.setTo(8);
loop.setIncrement(.1);
